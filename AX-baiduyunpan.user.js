...
(function(require, define, Promise) {
    ...
    unsafeWindow.axeldown = function(urls, filename) {
        urls = urls.split('|');
    ...
    function showError(msg) {
        ...
        var $dialog = $('<div id="errorDialog">' + '<h3>AX-baiduyunpan:程序异常</h3>' + '<div class="dialog-body"><p>请尝试更新脚本或复制以下信息提交issue</p>' + '<p>Exception: ' + msg + '</p>' + '<p>Script Ver: ' + GM_info.script.version + '</p>' + '<p>TemperMonkey Ver: ' + GM_info.version + '</p>' + '<p>UA: ' + navigator.userAgent + '</p>' + '</div><hr><a class="close" href="javascript:;">关闭</a></div>');
        $dialog.on('click', '.close',
        function(event) {
            $dialog.remove();
        }).appendTo(document.body);
    }
    define('ax-yunpan:pageInfo',
    function(require) {
        ...
        var PAGE_CONFIG = {
            ...
            share: {
                ...
                style: function() {
                    var styleList = ['.KPDwCE .QxJxtg{z-index: 2;}', '.module-share-header .slide-show-right{width: auto;}', '.ax-yunpan-dropdown-button.g-dropdown-button.button-open .menu{z-index:41;}', '.module-share-header .slide-show-header h2{width:230px;}', '.KPDwCE .xGLMIab .g-dropdown-button.ax-yunpan-dropdown-button{margin: 0 5px;}'];
            ...
            enterprise: {
                ...
                style: function() {
                    var styleList = ['.ax-yunpan-dropdown-button .icon-download{background-image: url(/box-static/business-function/infos/icons_z.png?t=1476004014313);}', '.ax-yunpan-dropdown-button .g-button:hover .icon-download{background-position: 0px -34px;}'];
                    GM_addStyle(styleList.join(''));
                }
            }
        };
    ...
    define('ax-yunpan:downloadBtnInit',
    function(require) {
        ...
        var dServ = null;
        require.async(prefix + 'download/service/dlinkService.js',
        function(dlinkService) {
            dServ = dlinkService;
        });
        var exDlBtnConfig = {
            type: 'dropdown',
            ...
            menu: [{
                ...
                'click': function() {
                    ...
                    var text = '<label for="txt">Axeldown服务器地址: </label><input type="text" id="axeladdr" style="white-space: nowrap;" value="' + axeladdr + '" /><br><br><label for="txt">Axeldown服务器端口: </label><input type="text" id="axelport" style="white-space: nowrap;" value="' + axelport + '" />';
                    ...
                    dialog.buttonIns[0].dom.attr({
                        'href': 'javascript:var axeladdr = document.getElementById("axeladdr").value;var axelport = document.getElementById("axelport").value;if (window.localStorage) {localStorage.setItem("axeladdr", axeladdr);localStorage.setItem("axelport", axelport);} else {Cookie.write("axeladdr", axeladdr);Cookie.write("axelport", axelport);};',
            ...
            },
            {
                ...
                'click': function() {
                    ...
                    } else { [].push.apply(foldersList, filesList);
                    }
                    var requestMethod;
                    ...
                    Promise.all(promises).then(function(result) {
                        ...
                        result.filter(function(e) {
                            ...
                            } else { [].push.apply(dlinks, (e.dlink || e.list || []).map(function(e) {
                                    return e.dlink;
                                }));
                            }
                        });
                        ...
                        //'<br><input type="text" id="thread" style="width:30%;white-space: nowrap;">下载线程数</td>';
                        var filenames;
                        var foldersList = selectedList.filter(function(e) {
                            return e.isdir === 1;
                        });
                        ...
                        //alert(urls);
                        dialog.buttonIns[0].dom.attr({
                            'href': "javascript:window.axeldown('" + urls + "', '" + filenames + "');",
                            'data-clipboard-action': 'copy',
    ...
    define('ax-yunpan:pluginInit.js',
    function(require, module, exports) {
        ...
        var dmPromise = new Promise(function(resolve, reject) {
            ...
            require.async(prefix + 'download/service/downloadManager.js',
            function(dm) {
        ...
        var gjcPromise = new Promise(function(resolve, reject) {
            ...
            require.async(prefix + 'download/service/guanjiaConnector.js',
            function(gjC) {
                gjC.init = function() {
                    setTimeout(function() {
                        ctx.ui.tip({
        ...
        var ddsPromise = new Promise(function(resolve, reject) {
            ...
            require.async(prefix + 'download/service/downloadDirectService.js',
            function(dDS) {
                var $preDlFrame = null;
        ...
        Promise.all([dmPromise, gjcPromise, ddsPromise]).then(function() {
            try {
                ...
                ctx.ui.tip({
                    mode: 'success',
                    msg: 'AX-baiduyunpan: 插件加载成功'
                });
            } catch(e) {
                ctx.ui.tip({
                    mode: 'caution',
                    msg: 'AX-baiduyunpan: 插件加载成功，按钮初始化失败',
                    autoClose: false,
                    hasClose: true
                });
            }
